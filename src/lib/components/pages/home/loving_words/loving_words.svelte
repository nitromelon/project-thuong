    ...
    <div class="slider" style="transform: translateY(-{currentIndex * 100}vh)">
        <div class="slide image-container">
            <div class="text-overlay">
                ...
                <p>
                    {display_text($language_perference, "Dự án này không chỉ là hành trình của riêng mình. Từng dòng, từng thước phim, từng ý tưởng đều có sự góp mặt của những người đã thương mình bằng cách riêng của họ. Đây là nơi mình dệt những lời cảm ơn qua chữ, để ghi nhớ, để biết ơn, và để không quên.",
        ...
        <div class="slide image-container">
            ...
            <div class="text-overlay">
                ...
                <p>
                    {display_text($language_perference, "Dù không trực tiếp quay hay dựng, nhưng luôn là người đồng hành thầm lặng nhất, cho mình thời gian, không gian và sự yên tâm để làm tới nơi tới chốn. Là nhà tài trợ vô điều kiện mỗi khi cần mua tài liệu, thiết bị, không quản vất vả đợi mình đi sớm về khuya. Hơn cả là ủng hộ mình dấn thân.",
        ...
        <div class="slide image-container" id="production">
            ...
            <div class="text-overlay">
                ...
                <p>
                    {display_text($language_perference, "Xin gửi lời cảm ơn đến Việt Anh, anh Đức Anh và Đặng Nguyễn vì đã góp công, góp sức và đồng hành cùng mình qua từng khung hình, từng bản dựng, từng chi tiết nhỏ nhất.",
        ...
        <div class="slide image-container" id="followers">
            ...
            <div class="text-overlay">
                ...
                <p>
                    {display_text($language_perference, "Cảm ơn các bạn - những người đã ủng hộ và dõi theo 'Chữ và Nghĩa'. Dù đây chỉ là một hành trình nhỏ còn nhiều thiếu sót, nhưng luôn nhận được sự đón nhận từ mọi người và đó chính là nguồn động lực để dự án tiếp tục được nuôi lớn từng ngày.",
